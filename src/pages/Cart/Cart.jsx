              ...
              <div class="horizontal-card-sectionTwo flex-col">
                <div class="horizontal-card-content">
                  ...
                  <div class="vertical-card-content-three flex-start-row">
                    <p class="margin-top-bottom-zero current-price">
                      {item.price}
                    </p>
                  </div>
                  <div class="quantity-section flex">
                    <span>quantity:</span>
                    <button
                      class="decre-btn flex-row-center"
                      onClick={() => decrementQuantity(item, auth.token)}
                    >
                      -
                    </button>
                    ...
                    <button
                      class="incre-btn"
                      onClick={() => incrementQuantity(item, auth.token)}
                    >
                      +
                    </button>
                  </div>
                ...
                <div class="horizontal-card-btn flex-col-center">
                  ...
                  <a
                    ...
                    onClick={() => removeFromCart(item, auth.token)}
                  >
                    Remove from Cart
                  </a>
                </div>
